# Discord + Hermes vs zellij/neovim/herm Stack — Complementary Roles

Research documented: 2026-06-18
Sources: This session — architectural analysis of both layers
...
- `ai-terminal-stack-remote-access` — Mobile access via Tailscale
- `hermes-discord-setup` — Discord bot configuration (to be created)

---

## Tags
`#discord` `#hermes` `#workflow` `#mobile` `#integration` `#architecture`